...
<body background="Images/MyBackground.png" bgcolor="#FFCC99">
    ...
    <div class="box">
		...
		$id = $_GET['txtid'];
		include ("connect.php");
		$i ="select * from tbl_customer where id=".$id;
		$h= mysql_query($i);
    ...
    <table><form method="post" action="">
        ...
        <tr>
            ...
            <a href="index7.php"><img src="Images/Users_Group.png" title="Go Back"/></a>
            </td>
        </tr>
	</form></table>
    </div>
    ...
    <?php
        include ("connect.php");
        $i = mysqli_query("update tbl_customer set name='".$_POST['txtname']."', company detailsr='".$_POST['txtgender']."', email='".$_POST['txtdob']."', address='".trim($_POST['txtaddress'])."', phone='".$_POST['txtsubject']."', date='".$_POST['txtdate']."' where id=".$_POST['txtid']);
        if($i==true){
        echo '<META HTTP-EQUIV="Refresh" Content="0; URL=index7.php">';
        }
