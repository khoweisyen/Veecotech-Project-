    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
          ...
          <div class="form-group">
            <label for="Contact-person" class="control-label">Contact person Name:</label>
           ...
           <div class="form-group">
            ...
            <input type="text" class="form-control" id="PhoneNB">
          </div>
            
           <div class="form-group">
            <label for="Mobile" class="control-label">Mobile</label>
            <input type="text" class="form-control" id="MobileNB">
          </div>
            
           <div class="form-group">
            <label for="Address" class="control-label">Address</label>
            <textarea class="form-control" id="Adres"></textarea>
          </div>
            
           <div class="form-group">
            <label for="Country" class="control-label">Country</label>
            <input type="text" class="form-control" id="LoCountry">
          </div>
        </form>
      </div>
  ...
  <div class="modal fade" id="Delete" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p> Are you sure want to delete customer details?</p>
        </div>
        <div class="modal-footer">
