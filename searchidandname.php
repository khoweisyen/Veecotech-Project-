...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="addnew" href="index.php" style="font-face:Khmer OS Battambang; font-size:16px;">ត្រលប់ក្រោយ</a></font>
    ...
    <?php
		if($cbo=="ID")
		{
			$id = mysqli_query("SELECT * FROM tbl_student WHERE stuid='$search'");
	?>
	...
	?>
		...
		{
			$na = mysqli_query("SELECT * FROM tbl_student WHERE name like '".$search."%'");
	?>
    <?php
	...
	?>
     ...
     <?php
				...
				{
        $add = mysqli_query("SELECT * FROM tbl_student WHERE address like '".$search."%'");
     ?>
		<?php
		...
		?>
			...
			{
			$g = mysqli_query("SELECT * FROM tbl_student WHERE gender like '".$search."%'");
			?>  
			<?php
